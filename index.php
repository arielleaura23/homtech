        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Yaounde, TKC (derrière flemming)
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Intership</a>
                            ...
                            <div class="col-lg-4">
                                <div class="bg-light rounded">
                                    ...
                                    <div class="p-4 pt-0">
                                        ...
                                        <a href="" class="btn btn-primary-gradient rounded-pill py-2 px-4 mt-4">Contactez nous sur whatsapp</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="bg-light rounded border">
                                    ...
                                    <div class="p-4 pt-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-2"><span>Sponsorisation des posts (1/Semaine)</span><i class="fa fa-check text-primary-gradient pt-1"></i></div>
                                        ...
                                        <a href="" class="btn btn-secondary-gradient rounded-pill py-2 px-4 mt-4">Contactez nous sur whatsapp</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
