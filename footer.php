            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        ...
                        <p class="mt-3 mb-4">Nous sommes une équipe passionnée d'experts en technologie, dédiée à fournir des solutions innovantes et sur mesure pour répondre aux besoins de votre entreprise. </p>
                        <form action="">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Hometch</a>. All Rights Reserved.
                            ...
                            Designed by <a class="text-white border-bottom" href="#">Homtech</a>
                        </p>
                    </div>
                </div>
            </div>
